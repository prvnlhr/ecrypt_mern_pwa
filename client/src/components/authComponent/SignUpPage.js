      ...
      <div className={styles.formWrapper}>
            ...
            >
              ...
              <p>
                {formMessage.message !== undefined
                  ? formMessage.message
                  : authState.authResponseMessage !== undefined &&
        ...
        <form className={styles.formTagContainer} onSubmit={handleFormSubmit}>
          <div className={styles.firstNameWrapper}>
            <div
              className={`${styles.firstNameContainer} ${
                currFocusField === 1 && styles.focusFieldStyle
              } `}
            >
          ...
          <div className={styles.LastNameWrapper}>
            <div
              className={`${styles.lastNameContainer} ${
                currFocusField === 2 && styles.focusFieldStyle
              } `}
            >
              <div className={styles.iconDiv}>
                <svg
          ...
          <div className={styles.emailAddressWrapper}>
            <div
              className={`${styles.emailAddressContainer} ${
                currFocusField === 3 && styles.focusFieldStyle
              } `}
            >
              <div className={styles.iconDiv}>
          ...
          <div className={styles.passwordWrapper}>
            <div
              className={`${styles.passwordContainer} ${
                currFocusField === 4 && styles.focusFieldStyle
              } `}
            >
              <div className={styles.iconDiv}>
                <Icon
          ...
          <div className={styles.confirmPasswordWrapper}>
            <div
              className={`${styles.confirmPassContainer} ${
                currFocusField === 5 && styles.focusFieldStyle
              } `}
            >
              <div className={styles.iconDiv}>
                <Icon
