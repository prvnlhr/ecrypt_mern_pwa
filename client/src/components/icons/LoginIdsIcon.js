...
const LoginIdsIcon = () => {
    return (
        <svg
            ...
            <circle r="2" transform="matrix(-1 0 0 1 8.5 12.5)" stroke="#2B3F6C" stroke-width="1.5" />
        </svg>
